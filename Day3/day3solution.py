...
def main():
	...
	run2 = check_slope(3,1, non_repeating_map)
	run3 = check_slope(5,1, non_repeating_map)
	run4 = check_slope(7,1, non_repeating_map)
	run5 = check_slope(1,2, non_repeating_map)
	run_sum = run1 * run2 * run3 * run4 * run5

	print('Part 1 = ' + str(run2))
